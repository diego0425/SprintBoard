...
namespace SprintBoard.Test.Integration
{
        ...
        : IClassFixture<CustomWebApplicationFactory>
    {
        ...
        /// <summary>
        /// Verifies that HTTP responses include the correlation
        /// identifier generated by the application pipeline.
        /// </summary>
        [Fact]
        public async Task HealthLive_ShouldReturnCorrelationIdHeader()
        {
            // Arrange
            const string endpoint =
                "/health/live";
